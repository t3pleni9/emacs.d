...
#+RESULTS:
| propertize | (concat dayname   day   monthname   12-hours : minutes   am-pm) | (quote face) | (quote bold) |
...
("ts" "Shopping list [inbox]" checkitem
	 (file+headline home-tasks-file-path "Shopping")
	 "- [ ] %i%? ")

("tr" "Reminder [inbox]" entry
	 (file+headline tasks-file-path "Reminders")
	 "* TODO %i%?")
