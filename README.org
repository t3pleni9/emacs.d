...
#+RESULTS:
| (lambda nil (set (make-local-variable 'evil-emacs-state-cursor) (list nil))) | (lambda nil (set (make-local-variable 'evil-evilified-state-cursor) (list nil))) | pdf-view-restore-mode | pdf-tools-enable-minor-modes |
