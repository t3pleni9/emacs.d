...
** Configuration
To install, clone this repository, and replace it with the =.emacs.d= in you =$HOME= directory, for EMACS <= v26.1
#+begin_src bash
cd ~
...
#+begin_src emacs-lisp
(setq journal-file-path "~/Documents/org-notes/exocortex/today.org")
#+end_src
...
#+begin_src emacs-lisp
(setq capture-file-path "~/Documents/org-notes/exocortex/capture.org")
...
"~/Documents/org-notes/exocortex/today.org"
"~/Documents/org-notes/research/bibliography/references.org"
"~/Documents/org-notes/research/reading-list/library.org"
"~/Documents/org-notes/exocortex/daily.org"
"~/Documents/org-notes/Dropbox/org-notes/home/tasks.org"
))
#+end_src
...
** Org-clock
Automatically start the clock when the task moves to =INPROGRESS=
#+begin_src emacs-lisp
...
Org-ref Files
#+begin_src emacs-lisp
(setq reftex-default-bibliography '("~/Documents/org-notes/research/bibliography/references.bib" "~/Documents/org-notes/research/bibliography/references_2.bib" "~/Documents/org-notes/research/bibliography/references_3.bib")
      org-ref-default-bibliography '("~/Documents/org-notes/research/bibliography/references.bib" "~/Documents/org-notes/research/bibliography/references_2.bib" "~/Documents/org-notes/research/bibliography/references_3.bib")
...
#+begin_src emacs-lisp
(setq bibtex-completion-bibliography '("~/Documents/org-notes/research/bibliography/references.bib" "~/Documents/org-notes/research/bibliography/references_2.bib" "~/Documents/org-notes/research/bibliography/references_3.bib")
...
#+begin_src emacs-lisp
  (setq bibtex-completion-notes-template-multiple-files 
        (concat "#+TITLE: ${title} : ${author-or-editor} (${year})\n#+ROAM_KEY: cite:${=key=}\n#+INTERLEAVE_PDF: "
...
#+begin_src emacs-lisp
(setq-default org-roam-directory "~/Documents/org-notes/research")
#+end_src
...
(setq-default org-roam-capture-templates '(("d" "default" plain
  ...
  "%?" :file-name "notes/%<%Y%m%d%H%M%S>-${slug}" :head "#+TITLE: ${title}\n#+ROAM_ALIAS: \"${slug}\"\n%K - %a\n%i\n
" :unnarrowed t)))
#+end_src
