...
#+HTML:<div align=center><a href="https://gitlab.com/t3pleni9/emacs-d"><img alt="Emacs Logo" width="60" height="60" src="https://upload.wikimedia.org/wikipedia/commons/0/08/EmacsIcon.svg"></a></div>
...
#+begin_src emacs-lisp
  (advice-add 'org-agenda :before #'delete-other-windows)
#+end_src
...
(setq org-refile-targets '((projects-file-path :maxlevel . 3)
                           ...
                           (bookmarks-file-path :maxlevel . 1)))
